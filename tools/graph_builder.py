...
def build_several_phases(iter_count: int, depth: int, deltas: List[int]):
    ...
    ax1.plot(iterations2, line_length2, 'o', label=r'$10$', c='red', linewidth=1)
    ax1.plot(iterations3, line_length3, 'o', label=r'$100$', c='blue', linewidth=1)

    fig2, ax2 = plt.subplots()
    ax2.plot(iterations1, square1, 'X', label=r'$1$', c='black', linewidth=1)
    ax2.plot(iterations2, square2, 'X', label=r'$10$', c='red', linewidth=1)
    ax2.plot(iterations3, square3, 'X', label=r'$100$', c='blue', linewidth=1)

    fig3, ax3 = plt.subplots()
    ax3.plot(iterations1, volume1, '*', label=r'$1$', c='black', linewidth=1)
    ax3.plot(iterations2, volume2, '*', label=r'$10$', c='red', linewidth=1)
    ax3.plot(iterations3, volume3, '*', label=r'$100$', c='blue', linewidth=1)

    fig4, ax4 = plt.subplots()
    ax4.plot(iterations1, s_l1, '*',  label=r'$1$', c='black', linewidth=1)
    ax4.plot(iterations2, s_l2, '*', label=r'$10$', c='red', linewidth=1)
    ax4.plot(iterations3, s_l3, '*', label=r'$100$', c='blue', linewidth=1)

    fig5, ax5 = plt.subplots()
    ax5.plot(iterations1, v_s1, '*', label=r'$1$', c='black', linewidth=1)
    ax5.plot(iterations2, v_s2, '*', label=r'$10$', c='red', linewidth=1)
    ax5.plot(iterations3, v_s3, '*', label=r'$100$', c='blue', linewidth=1)

    fig6, ax6 = plt.subplots()
    ax6.plot(iterations1, v_l1, '*', label=r'$1$', c='black', linewidth=1)
    ax6.plot(iterations2, v_l2, '*', label=r'$10$', c='red', linewidth=1)
    ax6.plot(iterations3, v_l3, '*', label=r'$100$', c='blue', linewidth=1)

    fig7, ax7 = plt.subplots()
    ax7.plot(iterations1, v_v_base1, '*', label=r'$1$', c='black', linewidth=1)
    ax7.plot(iterations2, v_v_base2, '*', label=r'$10$', c='red', linewidth=1)
    ax7.plot(iterations3, v_v_base3, '*', label=r'$100$', c='blue', linewidth=1)
...
if __name__ == '__main__':
    ...
    build_several_phases(1000, 7, [1, 10, 100])
